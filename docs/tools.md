...
| `submit_result` | Hasil akhir JSON terstruktur 1× | NO_PROMPT, `exec --json` verbatim. `result.findings` eksplisit diproyeksikan sebagai `finding.detected`. Pengganti `response_format` |
